...
const CUSTOMIZATIONS_DIR = join(LIFEOS_DIR, "USER", "CUSTOMIZATIONS", "SKILLS", "LocalIntelligence")
const LEGACY_DATA_DIR = join(LIFEOS_DIR, "MEMORY", "DATA", "LocalIntelligence")
...
const REFRESH_SCRIPT = join(CONFIG_ROOT, "skills", "LocalIntelligence", "Tools", "Refresh.ts")
