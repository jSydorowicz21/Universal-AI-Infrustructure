...
const REGISTRY: Record<string, SourceSpec[]> = {
  ...
  hooks: [
    { name: "hooks/", path: join(CONFIG_ROOT, "hooks"), expand: true },
    { name: "settings.json", path: join(CONFIG_ROOT, "settings.json") },
  ],
  skills: [
    { name: "skills/", path: join(CONFIG_ROOT, "skills"), expand: true },
  ],
  agents: [
    { name: "agents/", path: join(CONFIG_ROOT, "agents"), expand: true },
  ],
  docs: [
  ...
  amber: [
    ...
    { name: "_X/State/", path: join(CONFIG_ROOT, "skills", "_X", "State") },
  ],
  assistant: [
