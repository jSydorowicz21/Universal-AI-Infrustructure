...
- [x] ISC-16: GitHub Actions run `29676583891` at code head `9fa2f87` passed all 12 blocking compile, unit, fixture, and conformance matrix jobs across Windows, macOS, and Linux; optional credentialed discovery remained skipped by design.
...
- 2026-07-18 renewed hosted verification: run `29676583891` passed the Codex-expanded conformance gate plus compile, unit, and fixture jobs on Windows, macOS, and Linux—12 blocking jobs total; optional live discovery stayed explicitly skipped and non-certifying.
...
- CI contract: GitHub Actions run `29676583891` at code head `9fa2f87` passed compile, unit, fixtures, and the Codex-expanded conformance suite on Windows, macOS, and Linux—12 blocking jobs total. Optional live vendor discovery was skipped by design and remains non-certifying; Claude review automation run `29676586084` also passed through its explicit missing-credential skip path.
